      ...
      {slot && (
        ...
        >
          ...
          >
            ...
            <div className="flex items-start gap-3 p-3.5 rounded-xl bg-amber-50 border border-amber-200 text-amber-900 shadow-xs">
              <svg className="w-5 h-5 text-amber-600 shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
              </svg>
              <div className="flex flex-col gap-0.5 text-xs">
                <span className="font-extrabold text-amber-950">Required Language Proficiency</span>
                <p className="leading-relaxed text-amber-800">
                  Warning: You must possess an <strong className="font-extrabold text-amber-950 underline">ADVANCED</strong> level in <span className="font-bold text-amber-950">{slot.exchangeLanguage?.name || "the exchange language"}</span> to book this session.
                </p>
              </div>
            </div>
