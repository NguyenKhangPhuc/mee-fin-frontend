    ...
    <div className={`min-h-screen px-3 sm:px-6 lg:px-8 py-6 ${designTokens.colors.bg.page} font-sans relative`}>
      <div className="w-full max-w-[1800px] mx-auto flex flex-col gap-8">
        ...
        <motion.div
          ...
          className={`p-3 sm:p-8 lg:p-10 ${designTokens.colors.bg.card} ${designTokens.shadows.card} ${designTokens.radii.card} border ${designTokens.colors.border.default} flex flex-col gap-6`}
        >
          <SlotCalendar
